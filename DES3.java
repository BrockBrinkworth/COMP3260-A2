...
public class DES3 extends DES_Steps
{
    //Same as in DES0
    private String name;
    private String p;
    ...
    //Same as in DES0
    public DES3(String aName, String p, String nP, String k, String nK)
    {
        name = aName;
        this.p = p;
        this.nP = nP;
    ...
    //Same as in DES0, but Fiestal Function modified as outlined in Assignment spec
    ...
    //Same as DES0, but Fiestal Function modified as outlined in Assignment Spec
    private String roundsAndSwap(String input, Vector<String> keyList, Vector<String> rState){
        ...
        for(int i = 0; i < 16; i++){
            ...
            tempR = sBox(tempR);
            //Modification was removing the Permutation P normally done as the last part of function(F)
            //tempR = fPerm(tempR);
